## Model: `stg_facebook_ads__basic_ad_action_values`

`stg_facebook_ads__basic_ad_action_values`

*   **Unique ID:** `model.facebook_ads.stg_facebook_ads__basic_ad_action_values`
*   **FQN:** `prod.ads_marts.stg_facebook_ads__basic_ad_action_values`
...
*   **Columns:**
 ...
 | `[]` | `{}` |
    ...
    | `CONVERSIONS_VALUE` | 7 | `FLOAT` | Monetary value associated with the conversion action using the default attribution window. | Monetary value associated with the conversion action using the default attribution window. | `[]` | `{}` |
*   **Depends On (Parents):**
    *   `macro.dbt.type_bigint`
    *   `macro.dbt.type_float`
    *   `macro.facebook_ads.facebook_ads_fill_pass_through_columns`
    *   `macro.facebook_ads.get_basic_ad_action_values_columns`
    *   `macro.fivetran_utils.fill_staging_columns`
    *   `macro.fivetran_utils.source_relation`
    *   `model.facebook_ads.stg_facebook_ads__basic_ad_action_values_tmp`
