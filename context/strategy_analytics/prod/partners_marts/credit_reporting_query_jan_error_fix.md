## Model: `credit_reporting_query_jan_error_fix`

`credit_reporting_query_jan_error_fix`

*   **Unique ID:** `model.cherry_data_model.credit_reporting_query_jan_error_fix`
*   **FQN:** `prod.partners_marts.credit_reporting_query_jan_error_fix`
*   **Description:** (No description provided)
*   **Tags:** `['external_partners', 'external', 'archive']`
...
*   **Depends On (Parents):**
    ...
    *   `model.cherry_data_model.src_idicore_bankruptcies`
    ...
    *   `source.cherry_data_model.cherry_data.borrower_address_history`
