## Model: `retention_average_volumes_and_percent_transacting_pdm_combined_aesthetics_xf`

`retention_average_volumes_and_percent_transacting_pdm_combined_aesthetics_xf`

*   **Unique ID:** `model.cherry_data_model.retention_average_volumes_and_percent_transacting_pdm_combined_aesthetics_xf`
*   **FQN:** `prod.revenue_marts.retention_average_volumes_and_percent_transacting_pdm_combined_aesthetics_xf`
*   **Description:** **Practice Development Aesthetics Specialty Model**
Specialized model focusing on Practice Development team performance for aesthetics practices  (MedSpa and Plastic Surgery), with "Aesthetics" segment classification for  combined analysis of PDM's aesthetics portfolio performance.
**Aesthetic Focus:** - MedSpa and Plastic Surgery practices under Practice Development - Combined "Aesthetics" segment for unified aesthetic practice analysis - Same practice potential thresholds as PDM core model (>$10K or Plastic Surgery) - Calvin Bohn PDM Aesthetics team classification logic
**Use Case:** - Aesthetics-specific retention strategy development and performance tracking - Cross-industry aesthetic practice benchmarking and best practice identification - PDM aesthetics team specialization measurement and resource allocation
...
*   **Columns:**
 ...
 | `[]` | `{}` |
    | `AVERAGE_LAST_30_HEALTHY_VOLUME_UNCAPPED` | 10 | `TEXT` |  |  | `[]` | `{}` |
 ...
 | `[]` | `{}` |
    | `TEST_GROUP_TRAILING_7_DAY_AVERAGE_LAST_30_HEALTHY_VOLUME_UNCAPPED` | 17 | `TEXT` |  |  | `[]` | `{}` |
 ...
 | `[]` | `{}` |
    | `TRAILING_7_DAY_AVERAGE_LAST_30_HEALTHY_VOLUME_UNCAPPED` | 23 | `TEXT` |  |  | `[]` | `{}` |
