## Model: `pivot_inbound_genesys_xf_archive`

`pivot_inbound_genesys_xf_archive`

*   **Unique ID:** `model.cherry_data_model.pivot_inbound_genesys_xf_archive`
*   **FQN:** `prod.archive.pivot_inbound_genesys_xf_archive`
*   **Description:** (No description provided)
*   **Tags:** `['archive', 'genesys', 'contact_rate', 'one_touch']`
...
*   **Columns:**
    ...
    | `NOVERSLA` | 50 | `NUMBER` |  |  | `[]` | `{}` |
*   **Depends On (Parents):**
    *   `model.cherry_data_model.int_inbound_genesys`
