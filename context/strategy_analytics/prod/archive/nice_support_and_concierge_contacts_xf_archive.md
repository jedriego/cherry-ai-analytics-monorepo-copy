## Model: `nice_support_and_concierge_contacts_xf_archive`

`nice_support_and_concierge_contacts_xf_archive`

*   **Unique ID:** `model.cherry_data_model.nice_support_and_concierge_contacts_xf_archive`
*   **FQN:** `prod.archive.nice_support_and_concierge_contacts_xf_archive`
*   **Description:** This model transforms and consolidates support and concierge contact data from NICE inbound and outbound systems. It includes contact details, agent information, disposition data, and metrics for support and concierge team interactions. The model is tagged for archive.
