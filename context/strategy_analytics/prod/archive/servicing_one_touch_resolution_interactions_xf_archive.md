## Model: `servicing_one_touch_resolution_interactions_xf_archive`

`servicing_one_touch_resolution_interactions_xf_archive`

*   **Unique ID:** `model.cherry_data_model.servicing_one_touch_resolution_interactions_xf_archive`
*   **FQN:** `prod.archive.servicing_one_touch_resolution_interactions_xf_archive`
...
3. Borrower Queue
 ...
 | `[]` | `{}` |
*   **Depends On (Parents):**
    *   `model.cherry_data_model.int_servicing_one_touch_contact_information_joined`
