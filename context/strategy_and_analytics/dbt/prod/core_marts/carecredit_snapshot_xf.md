...
*   **Columns:**
 ...
 | `[]` | `{}` |
    | `CHERRY_SF_ID` | 41 | `TEXT` | Cherry's Salesforce account identifier for the matched practice, used for CRM integration and  account management. Only populated when a match exists between CareCredit and Cherry systems.  Enables linking competitive intelligence to Cherry's sales and account management processes.
