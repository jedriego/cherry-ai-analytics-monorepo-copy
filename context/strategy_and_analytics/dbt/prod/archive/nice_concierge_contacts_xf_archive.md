## Model: `nice_concierge_contacts_xf_archive`

`nice_concierge_contacts_xf_archive`

*   **Unique ID:** `model.cherry_data_model.nice_concierge_contacts_xf_archive`
*   **FQN:** `prod.archive.nice_concierge_contacts_xf_archive`
*   **Description:** This model transforms and consolidates concierge contact data from NICE inbound and outbound systems. It includes contact details, agent information, disposition data, and metrics for concierge team interactions. The model is tagged for archive.
