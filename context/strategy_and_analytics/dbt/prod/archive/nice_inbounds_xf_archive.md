## Model: `nice_inbounds_xf_archive`

`nice_inbounds_xf_archive`

*   **Unique ID:** `model.cherry_data_model.nice_inbounds_xf_archive`
*   **FQN:** `prod.archive.nice_inbounds_xf_archive`
