## Model: `credit_reporting_query_eoscar_archive`

`credit_reporting_query_eoscar_archive`

*   **Unique ID:** `model.cherry_data_model.credit_reporting_query_eoscar_archive`
*   **FQN:** `prod.archive.credit_reporting_query_eoscar_archive`
...
*   **Columns:**
    ...
    | `DATE_CLOSED` | 20 | `TIMESTAMP_NTZ` |  |  | `[]` | `{}` |
    | `ACCOUNT_STATUS` | 21 | `TEXT` |  |  | `[]` | `{}` |
    | `PAYMENT_RATING` | 22 | `TEXT` |  |  | `[]` | `{}` |
    | `DATE_OF_FIRST_DELINQUENCY` | 23 | `TIMESTAMP_NTZ` |  |  | `[]` | `{}` |
    ...
    | `DATE_OF_ACCOUNT_INFORMATION` | 35 | `TIMESTAMP_NTZ` |  |  | `[]` | `{}` |
    | `_RECORD_SOURCE` | 36 | `TEXT` |  |  | `[]` | `{}` |
*   **Depends On (Parents):**
    *   `model.cherry_data_model.applications_loans_xf`
    *   `model.cherry_data_model.borrowers_merged_emails_xf`
    *   `model.cherry_data_model.credit_reporting_query_eoscar_current`
    ...
    *   `source.cherry_data_model.cherry_data.loan_schedule`
