## Model: `zendesk_collections_and_recoveries_eligible_tickets_xf`

`zendesk_collections_and_recoveries_eligible_tickets_xf`

*   **Unique ID:** `model.cherry_data_model.zendesk_collections_and_recoveries_eligible_tickets_xf`
*   **FQN:** `prod.servicing_marts.zendesk_collections_and_recoveries_eligible_tickets_xf`
*   **Description:** This model contains all Zendesk tickets classified as collections-eligible based on customer_type  (Collections/Recoveries), regardless of which team actually handled them. Used for understanding  collections demand and classification accuracy.
