## Model: `retention_average_volumes_and_percent_transacting_csm_combined_aesthetics_xf`

`retention_average_volumes_and_percent_transacting_csm_combined_aesthetics_xf`

*   **Unique ID:** `model.cherry_data_model.retention_average_volumes_and_percent_transacting_csm_combined_aesthetics_xf`
*   **FQN:** `prod.revenue_marts.retention_average_volumes_and_percent_transacting_csm_combined_aesthetics_xf`
*   **Description:** **Customer Success Aesthetics Specialty Model**
Specialized model focusing on Customer Success team performance for aesthetics practices,  with "Aesthetics" segment classification for unified aesthetic practice analysis across  the Customer Success organization structure.
**Aesthetic Focus:** - MedSpa and Plastic Surgery practices under Customer Success - Combined "Aesthetics" segment for cross-practice type analysis - Same practice potential thresholds as CSM core model (>$7.5K or Plastic Surgery) - Ben Nebesky exclusion options for sensitivity analysis
**Use Case:** - Customer Success aesthetics strategy optimization and performance measurement - Cross-departmental aesthetics practice performance comparison (CSM vs PDM) - Aesthetics-focused resource allocation and team structure decisions
