## Model: `stg_google_ads__ad_group_stats`

`stg_google_ads__ad_group_stats`

*   **Unique ID:** `model.google_ads.stg_google_ads__ad_group_stats`
*   **FQN:** `prod.ads_marts.stg_google_ads__ad_group_stats`
...
*   **Columns:**
    ...
    | `AD_NETWORK_TYPE` | 7 | `TEXT` | The Google Ad network type used across the account. | The Google Ad network type used across the account. | `[]` | `{}` |
...
*   **Depends On (Parents):**
    ...
    *   `macro.google_ads.get_ad_group_stats_columns`
    *   `macro.google_ads.google_ads_fill_pass_through_columns`
    *   `model.google_ads.stg_google_ads__ad_group_stats_tmp`
