## Model: `zendesk_support_eligible_tickets_xf`

`zendesk_support_eligible_tickets_xf`

*   **Unique ID:** `model.cherry_data_model.zendesk_support_eligible_tickets_xf`
*   **FQN:** `prod.customer_support_marts.zendesk_support_eligible_tickets_xf`
*   **Description:** This model contains all Zendesk tickets classified as support-eligible based on customer_type  (Patient/Practice/Alle), regardless of which team actually handled them. Used for understanding  support demand and classification accuracy.
